...
GetAlleleFreqC <- function(filename, filetype, subVec, snpVec, indices, freqVec, numSubjects, numSNPs) {
    .Call('_BinaryDosage_GetAlleleFreqC', PACKAGE = 'BinaryDosage', filename, filetype, subVec, snpVec, indices, freqVec, numSubjects, numSNPs)
}
