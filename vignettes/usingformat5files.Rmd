...
The `vcftobd5` function converts a bgzipped VCF file to a Format 5 file pair.
...
```{r convert, eval = T, echo = T, message = F, warning = F}
...
```{r load_info, eval = T, echo = T, message = F, warning = F}
...
```{r snp_by_index, eval = T, echo = T, message = F, warning = F}
...
```{r snp_by_id, eval = T, echo = T, message = F, warning = F}
snp_id <- "1:12000:T:C"
...
```{r apply, eval = T, echo = T, message = F, warning = F}
