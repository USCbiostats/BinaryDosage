...
bdfile1a_woinfo <- c(tempfile(), tempfile())
bdinfo <- vcftobd(vcffiles = vcf1afile, bdfiles = bdfile1a_woinfo)
...
vcftobd(vcffiles = c(vcf1afile, vcf1ainfo), bdfiles = bdfile1a_winfo, format = 4)
...
``` {r, eval = T, echo = T, message = F, warning = F, tidy = T}
bdinfo1a_woinfo <- readRDS(bdfile1a_woinfo[2])
...
bdfile1a_woinfo_gz <- c(tempfile(),tempfile())
bdinfo <- vcftobd(vcffiles = vcf1afile_gz, bdfiles = bdfile1a_woinfo_gz)

bdfile1a_winfo_gz <- tempfile()
vcftobd(vcffiles = c(vcf1afile_gz, vcf1ainfo), bdfiles = bdfile1a_winfo_gz, format = 4)
...
bdinfo1a_woinfo_gz <- readRDS(bdfile1a_woinfo_gz[2])
...
bdfile2a <- c(tempfile(),tempfile())

bdinfo2a <- vcftobd(vcffiles = vcf2afile, bdfiles = bdfile2a)
...
bdfile1b.snpid0 <- c(tempfile(), tempfile())
bdfile1b.snpid1 <- c(tempfile(), tempfile())
bdfile1b.snpid2 <- c(tempfile(), tempfile())
bdfile1b.snpidm1 <- c(tempfile(), tempfile())

bdinfo1b.snpid0 <- vcftobd(vcffiles = vcf1brsfile, bdfiles = bdfile1b.snpid0)
bdinfo1b.snpid1 <- vcftobd(vcffiles = vcf1brsfile, bdfiles = bdfile1b.snpid1, snpidformat = 1)
bdinfo1b.snpid2 <- vcftobd(vcffiles = vcf1brsfile, bdfiles = bdfile1b.snpid2, snpidformat = 2)
bdinfo1b.snpidm1 <- vcftobd(vcffiles = vcf1brsfile, bdfiles = bdfile1b.snpidm1, snpidformat = -1)
