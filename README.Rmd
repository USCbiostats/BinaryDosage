---
title: "BinaryDosage: Convert Imputed SNP data to a Binary Dosage Format"
...
- **MergeBD** - Merge BDose files
  - (Currently retains only intersection of markers based on *Chromosome:BasePair_RefAllele_AltAllele*)
...
# Currently, must extract compressed files  
# (vcf.gz support TBD)
