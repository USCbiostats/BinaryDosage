...
protected:
	...
	CBinaryDosageReader(const std::string &_filename);
public:
	virtual ~CBinaryDosageReader();
...
class CBinaryDosageReader1 : public CBinaryDosageReader {
protected:
public:
	CBinaryDosageReader1(const std::string &_filename, const std::string &_famFilename, const std::string &_mapFilename) : CBinaryDosageReader(_filename) {}
	virtual ~CBinaryDosageReader1() {};
};

class CBinaryDosageReader4 : public CBinaryDosageReader {
protected:
public:
	CBinaryDosageReader4(const std::string &_filename);
	virtual ~CBinaryDosageReader4() {} ;
};
